...
Prompt/tool injection, arbitrary instruction data, malicious token metadata, compromised RPC/indexer, stale quotes, chain reorgs, blockhash-expiry re-signing, sandwich/MEV, delegation theft, signer compromise, dependency compromise, replay, policy drift, audit tampering, and runaway strategies.
